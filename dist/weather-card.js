 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */,dt=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(i){i.createProperty(e.key,t)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(i){i.createProperty(e.key,t)}},pt=(t,e,i)=>{e.constructor.createProperty(i,t)};function ut(t){return(e,i)=>void 0!==i?pt(t,e,i):dt(t,e)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}function gt(t){return ut({...t,state:!0})}
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var mt,ft,_t;null===(mt=window.HTMLSlotElement)||void 0===mt||mt.prototype.assignedElements,function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(ft||(ft={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(_t||(_t={}));var vt=function(t,e,i,s){s=s||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n
/*!
 * Chart.js v4.4.3
 * https://www.chartjs.org
 * (c) 2024 Chart.js Contributors
 * Released under the MIT License
 */};!function(){let t=!1;try{const e={get passive(){return t=!0,!1}};"undefined"!=typeof window&&"undefined"!=typeof document&&(window.addEventListener("test",null,e),window.removeEventListener("test",null,e))}catch(t){}}();var yt,$t={invalid_configuration:"Invalid configuration",invalid_entity:"Please define a weather entity",show_warning:"Show Warning",show_error:"Show Error"},bt="Temperature",wt="Temperature max",St="Temperature min",Et="Precipitations",At=["N","N-NE","NE","E-NE","E","E-SE","SE","S-SE","S","S-SW","SW","W-SW","W","W-NW","NW","N-NW","N"],xt={common:$t,temp:bt,tempHi:wt,tempLo:St,precip:Et,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:At},Nt=Object.freeze({__proto__:null,cardinalDirections:At,common:$t,default:xt,precip:Et,temp:bt,tempHi:wt,tempLo:St,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),Pt="Temperatur",Ct="Temperatur maks",Ot="Temperatur nat",kt="Nedbør",Ht=["N","N-NØ","NØ","Ø-NØ","Ø","Ø-SØ","SØ","S-SØ","S","S-SV","SV","V-SV","V","V-NV","NV","N-NV","N"],Tt={temp:Pt,tempHi:Ct,tempLo:Ot,precip:kt,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:Ht},Dt=Object.freeze({__proto__:null,cardinalDirections:Ht,default:Tt,precip:kt,temp:Pt,tempHi:Ct,tempLo:Ot,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),Ut="temperatur",Mt="Höchsttemperatur",Vt="Tiefsttemperatur",Wt="Niederschlag",Lt=["N","N-NO","NO","O-NO","O","O-SO","SO","S-SO","S","S-SW","SW","W-SW","W","W-NW","NW","N-NW","N"],Rt={temp:Ut,tempHi:Mt,tempLo:Vt,precip:Wt,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:Lt},zt=Object.freeze({__proto__:null,cardinalDirections:Lt,default:Rt,precip:Wt,temp:Ut,tempHi:Mt,tempLo:Vt,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),It="Temperatura",jt="Temperatura máxima",Bt="Temperatura mínima",Ft="Precipitations",Zt=["N","N-NE","NE","E-NE","E","E-SE","SE","S-SE","S","S-SO","SO","O-SO","O","O-NO","NO","N-NO","N"],Gt={temp:It,tempHi:jt,tempLo:Bt,precip:Ft,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:Zt},Kt=Object.freeze({__proto__:null,cardinalDirections:Zt,default:Gt,precip:Ft,temp:It,tempHi:jt,tempLo:Bt,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),qt="Température",Jt="Température max",Xt="Température min",Yt="Précipitations",Qt=["N","N-NE","NE","E-NE","E","E-SE","SE","S-SE","S","S-SO","SO","O-SO","O","O-NO","NO","N-NO","N"],te={temp:qt,tempHi:Jt,tempLo:Xt,precip:Yt,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:Qt},ee=Object.freeze({__proto__:null,cardinalDirections:Qt,default:te,precip:Yt,temp:qt,tempHi:Jt,tempLo:Xt,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),ie="temperatuur",se="Maximum temperatuur",ne="Minimum temperatuur",re="Neerslag",oe=["N","N-NO","NO","O-NO","O","O-ZO","ZO","Z-ZO","Z","Z-ZW","ZW","W-ZW","W","W-NW","NW","N-NW","N"],ae={temp:ie,tempHi:se,tempLo:ne,precip:re,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:oe},ce=Object.freeze({__proto__:null,cardinalDirections:oe,default:ae,precip:re,temp:ie,tempHi:se,tempLo:ne,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),le="Температура",he="Температура макси",de="Температура ночью",pe="Осадки",ue=["С","С-СВ","СВ","В-СВ","В","В-ЮВ","ЮВ","Ю-ЮВ","Ю","Ю-ЮЗ","ЮЗ","З-ЮЗ","З","З-СЗ","СЗ","С-СЗ","С"],ge={temp:le,tempHi:he,tempLo:de,precip:pe,uPress:"гПа",uSpeed:"м/с",uPrecip:"мм",cardinalDirections:ue},me=Object.freeze({__proto__:null,cardinalDirections:ue,default:ge,precip:pe,temp:le,tempHi:he,tempLo:de,uPrecip:"мм",uPress:"гПа",uSpeed:"м/с"}),fe="Temperatur",_e="Max temperatur",ve="Min temperatur",ye="Nederbörd",$e=["N","N-NO","NO","O-NO","O","O-SO","SO","S-SO","S","S-SV","SV","V-SV","V","V-NV","NV","N-NV","N"],be={temp:fe,tempHi:_e,tempLo:ve,precip:ye,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:$e},we=Object.freeze({__proto__:null,cardinalDirections:$e,default:be,precip:ye,temp:fe,tempHi:_e,tempLo:ve,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"});!function(t){t.ENGLISH="en",t.ENGLISH_BRITISH="en_GB",t.DANISH="da",t.GERMAN="de",t.SPANISH="es",t.FRENCH="fr",t.DUTCH="nl",t.RUSSIAN="ru",t.SWEDISH="sv"}(yt||(yt={}));const Se={en:Nt,en_GB:Nt,da:Dt,de:zt,es:Kt,fr:ee,nl:ce,ru:me,sv:we},Ee=yt.ENGLISH.valueOf();function Ae(t,e,i="",s=""){let n;try{if("test"===e.language)return"TRANSLATED";n=t.split(".").reduce(((t,e)=>t[e]),Se[e.language]),n||(n=t.split(".").reduce(((t,e)=>t[e]),Se[Ee]))}catch(e){try{n=t.split(".").reduce(((t,e)=>t[e]),Se[Ee])}catch(t){n=""}}if(""!==i&&""!==s&&n){Array.isArray(i)||(i=[i]),Array.isArray(s)||(s=[s]);for(let t=0;t<i.length;t++){n=n.replace(String(i[t]),String(s[t]));const e=n.match(/\{if ([a-z]+) is ([^}]+)} ?([^{]+) ?\{else} ?([^{]+)/i);if(e&&String(i[t]).replace(/[{}']+/g,"")==e[1]){n=String(s[t])==e[2]?n.replace(e[0],e[3]):n.replace(e[0],e[4])}}}return n}const xe=t=>t.locale||{language:t.language||yt.ENGLISH,number_format:ft.system},Ne=o`
  ha-card {
    cursor: pointer;
    margin: auto;
    padding: 1.3em 1em;
...
`;var Pe;window.customCards=window.customCards||[],window.customCards.push({type:"weather-card",name:"Animated weather card",description:"Lovelace animated weather card"}),console.info("%c  WEATHER-CARD  \n%c Version: 1.8.0 ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");let Ce=Pe=class extends nt{constructor(){super(),this.isPanel=!1,this.editMode=!1,this.numberElements=0}static async getConfigElement(){return await Promise.resolve().then((function(){return He})),document.createElement("weather-card-editor")}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={name:"",forecast_type:"daily",...t}}_needForecastSubscription(){return this._config&&this._config.entity_weather&&this._config.forecast_type&&"legacy"!==this._config.forecast_type}_unsubscribeForecastEvents(){this._subscribed&&(this._subscribed.then((t=>t())),this._subscribed=void 0)}async _subscribeForecastEvents(){var t,e,i,s;(this._unsubscribeForecastEvents(),this.isConnected&&this.hass&&this._config&&this._needForecastSubscription())&&(this._subscribed=(t=this.hass,e=this._config.entity_weather,i=this._config.forecast_type,s=t=>{this._forecastEvent=t},t.connection.subscribeMessage(s,{type:"weather/subscribe_forecast",forecast_type:i,entity_id:e})))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&this._config&&this.hass&&this._subscribeForecastEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeForecastEvents()}shouldUpdate(t){if(!this._config)return!1;if(t.has("_config")||t.has("_forecastEvent"))return!0;if(t.has("hass"))return!0;const e=t.get("hass")||void 0;return!e||e.themes!==this.hass.themes||e.locale!==this.hass.locale||(!1===Object.keys(this._config).every((t=>null===t.match(/^entity_/)||e.states[this._config[t]]===this.hass.states[this._config[t]]))||t.has("config"))}updated(t){this.hass&&this._config&&(!t.has("_config")&&this._subscribed||this._subscribeForecastEvents())}render(){if(!this._config||!this.hass)return R;const t=this.hass.states[this._config.entity_weather];return t?W`
    ...
    `:R}_handleClick(){vt(this,"hass-more-info",{entityId:this._config.entity_weather})}renderCurrent(){this.numberElements++;const t=this.hass.states[this._config.entity_weather];return t?W`
    ...
    `:R}renderDetails(){const t=this.hass.states[this._config.entity_sun],e=this.hass.states[this._config.entity_weather];if(!e||!t)return R;const i=xe(this.hass);let s,n;return t&&(s=new Date(t.attributes.next_rising),n=new Date(t.attributes.next_setting)),this.numberElements++,W`
      <ul class="variations ${this.numberElements>1?"spacer":""}">
        ...
        <li>
          ...
          <ha-icon
            style="margin-left: 0;"
            .icon=${Pe.getWindDirIcon(e.attributes.wind_bearing)}
          ></ha-icon>
    ...
    `}renderForecast(t){return t.forecast&&0!==t.forecast.length?(this.numberElements++,!0===this._config.graph?this.renderForecastGraph(t):this.renderForecastTable(t)):R}renderForecastTable(t){if(!t||!t.forecast||0===t.forecast.length)return R;const e=t.forecast.slice(0,this._config.forecastMaxColumn?this._config.forecastMaxColumn:5).map((e=>W`
          <div class="day">
        ...
        `));return W` <div class="forecast clear ${this.numberElements>1?"spacer":""}">${e}</div>`}renderForecastGraph(t){if(!t.forecast||0===t.forecast.length)return R;this.drawChart(t);const e=t.forecast.map((t=>t.condition?W` <i
            class="icon"
    ...
    `}drawChart(t){if(!t.forecast||0===t.forecast.length)return;const e=[],i=[],s=[],n=[];for(const r of t.forecast)e.push(new Date(r.datetime)),i.push(r.temperature),void 0!==r.templow&&s.push(r.templow),void 0!==r.precipitation&&n.push(r.precipitation);const r=getComputedStyle(document.body),o=r.getPropertyValue("--primary-text-color"),a=r.getPropertyValue("--divider-color"),c=xe(this.hass);this.chartData={data:{labels:e,datasets:[{label:"hourly"===t.type?Ae("temp",c):Ae("tempHi",c),type:"line",data:i,yAxisID:"TempAxis",borderWidth:2,tension:.4,pointRadius:0,pointHitRadius:5,fill:!1},{label:Ae("tempLo",c),type:"line",data:s,yAxisID:"TempAxis",borderWidth:2,tension:.4,pointRadius:0,pointHitRadius:5,fill:!1},{label:Ae("precip",c),type:"bar",data:n,maxBarThickness:22,barThickness:"flex",yAxisID:"PrecipAxis"}]},options:{animation:{duration:300,easing:"linear",onComplete:function(){const t=this.ctx;t.fillStyle=o;t.font=function(t,e,i){return e+" "+t+"px "+i}(10,"normal","Roboto"),t.textAlign="center",t.textBaseline="bottom";this.getDatasetMeta(2).data.forEach(((e,i)=>{const s=(Math.round(10*this.data.datasets[2].data[i])/10).toFixed(1),{barX:n,barY:r}=e.getProps(["x","y"]);t.fillText(s,n,r-5)}))}},plugins:{legend:{display:!1},tooltip:{mode:"index",callbacks:{title:t=>{const e=t[0];return new Date(e.parsed.x).toLocaleDateString(c.language,{month:"long",day:"numeric",weekday:"long",hour:"numeric",minute:"numeric"})},label:t=>2===t.datasetIndex?t.dataset.label+": "+(t.parsed.y?t.parsed.y+" "+this.getUnit("precipitation"):"0 "+this.getUnit("precipitation")):t.dataset.label+": "+t.parsed.y+" "+this.getUnit("temperature")}}},scales:{x:{type:"time",display:!1,axis:"x",ticks:{display:!1},grid:{display:!1},adapters:{date:{locale:c,config:this.hass?.config}}},DateAxis:{position:"top",axis:"x",grid:{display:!0,color:a},border:{display:!1,dash:[1,3]},ticks:{display:!0,source:"labels",autoSkip:!0,color:o,maxRotation:0,callback:e=>this.getDateString(t,e.toString())}},TempAxis:{position:"left",axis:"y",grid:{display:!0,color:a},border:{display:!1,dash:[1,3]},ticks:{display:!0,color:o},afterFit:t=>{t.width=28}},PrecipAxis:{position:"right",axis:"y",grid:{display:!1,color:a},border:{display:!1},min:0,suggestedMax:20,ticks:{display:!1,color:o},afterFit:t=>{t.width=15}}}}}}getWeatherIcon(t,e){return`${this._config.icons?this._config.icons:"https://cdn.jsdelivr.net/gh/MarcHagen/weather-card/dist/icons/animated/"}${e&&"below_horizon"===e.state?ct[t]:at[t]}.svg`}static getWindDirIcon(t){return ot[function(t,e){return Math.round(t*Math.pow(10,e))/Math.pow(10,e)}((t+22.5)/45,0)]}static getWindDir(t,e){return Ae("cardinalDirections",xe(t))[(e+11.25)/22.5]}getWindForce(){const t=this.hass.states[this._config.entity_weather];if("km"!==this.getUnit("length")||!t)return R;const e=Math.ceil(Math.cbrt(Math.pow(t.attributes.wind_speed/3.6/.836,2)));return W` | ${e} <span class="unit">Bft</span>`}getUnit(t){const e=this.hass.config.unit_system.length,i=xe(this.hass);switch(t){case"air_pressure":return"km"===e?Ae("uPress",i):"mbar";case"length":return e;case"precipitation":return"km"===e?Ae("uPrecip",i):"in";case"intensity":return"km"===e?Ae("uPrecip",i)+"/h":"in/h";case"precipitation_probability":return"%";default:return this.hass.config.unit_system[t]||""}}getDateString(t,e){return"hourly"===t.type?new Date(e).toLocaleTimeString(xe(this.hass).language,{hour:"numeric"}):new Date(e).toLocaleDateString(xe(this.hass).language,{weekday:"short"})}getCardSize(){return 1}static get styles(){return Ne}};t([ut({attribute:!1})],Ce.prototype,"hass",void 0),t([ut({attribute:!1})],Ce.prototype,"chartData",void 0),t([ut({type:Boolean})],Ce.prototype,"isPanel",void 0),t([ut({type:Boolean})],Ce.prototype,"editMode",void 0),t([gt()],Ce.prototype,"_config",void 0),t([gt()],Ce.prototype,"numberElements",void 0),t([gt()],Ce.prototype,"_subscribed",void 0),t([gt()],Ce.prototype,"_forecastEvent",void 0),Ce=Pe=t([ht("weather-card")],Ce);const Oe=["type","entity_weather","entity_sun","forecast_type","card_config_version","forecastMaxColumn","icons","details","forecast","current","graph","hidePrecipitation"];let ke=class extends nt{constructor(){super(...arguments),this._initialized=!1,this._config_version=2}setConfig(t){this._config=t}shouldUpdate(){return this._initialized||this._initialize(),!0}_configCleanup(){if(!this._config||!this.hass)return;let t={...this._config};t.entity&&(t.entity_weather=t.entity,delete t.entity);for(const e in this._config)Oe.includes(e)||delete t[e];t={...t,card_config_version:this._config_version},this._config=t,vt(this,"config-changed",{config:this.sortObjectByKeys(this._config)})}sortObjectByKeys(t){return Object.keys(t).sort().reduce(((e,i)=>(e[i]=t[i],e)),{})}async firstUpdated(){this._config&&this.hass&&this._config.card_config_version!==this._config_version&&this._configCleanup(),customElements.get("ha-entity-picker")||customElements.get("hui-entities-card")?.getConfigElement()}get _name(){return this._config?.name||""}get _entity_weather(){return this._config?.entity_weather||""}get _entity_sun(){return this._config?.entity_sun||"sun.sun"}get _forecast_type(){return this._config?.forecast_type||"daily"}get _icons(){return this._config?.icons||""}get _current(){return!1!==this._config?.current}get _details(){return!1!==this._config?.details}get _forecast(){return!1!==this._config?.forecast}get _graph(){return!1!==this._config?.graph}get _forecastMaxColumn(){return this._config?.forecastMaxColumn||5}get _hidePrecipitation(){return!0===this._config?.hidePrecipitation}render(){return this.hass&&this._config?W`
    ...
    `:R}_initialize(){void 0!==this.hass&&void 0!==this._config&&(this._initialized=!0)}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target;this[`_${e.configValue}`]!==e.value&&(e.configValue&&(""===e.value?delete this._config[e.configValue]:this._config={...this._config,[e.configValue]:void 0!==e.checked?e.checked:e.value}),vt(this,"config-changed",{config:this._config}))}_valueChangedNumber(t){if(!this._config||!this.hass)return;const e=t.target;this[`_${e.configValue}`]!==e.value&&(e.configValue&&(""===e.value||null===e.value?delete this._config[e.configValue]:this._config={...this._config,[e.configValue]:Number(e.value)}),vt(this,"config-changed",{config:this.sortObjectByKeys(this._config)}))}_valueChangedPicker(t){if(!this._config||!this.hass)return;const e=t.target,i=t.detail.value;this[`_${e.configValue}`]!==i&&(e.configValue&&(i?this._config={...this._config,[e.configValue]:i}:(this._config={...this._config},delete this._config[e.configValue])),vt(this,"config-changed",{config:this.sortObjectByKeys(this._config)}))}};ke.styles=o`
    .options {
      display: grid;
    }
  ...
  `,t([ut({attribute:!1})],ke.prototype,"hass",void 0),t([gt()],ke.prototype,"_config",void 0),ke=t([ht("weather-card-editor")],ke);var He=Object.freeze({__proto__:null,get WeatherCardEditor(){return ke}});export{Ce as WeatherCard};
