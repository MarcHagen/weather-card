 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var gt,mt,ft;null===(gt=window.HTMLSlotElement)||void 0===gt||gt.prototype.assignedElements,function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(mt||(mt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ft||(ft={}));var _t=function(t,e,i,s){s=s||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return n.detail=i,t.dispatchEvent(n),n
/*!
 * Chart.js v4.4.7
 * https://www.chartjs.org
 * (c) 2024 Chart.js Contributors
 * Released under the MIT License
 */};!function(){let t=!1;try{const e={get passive(){return t=!0,!1}};"undefined"!=typeof window&&"undefined"!=typeof document&&(window.addEventListener("test",null,e),window.removeEventListener("test",null,e))}catch(t){}}();var vt,yt={invalid_configuration:"Invalid configuration",invalid_entity:"Please define a weather entity",show_warning:"Show Warning",show_error:"Show Error"},$t="Temperature",bt="Temperature max",wt="Temperature min",St="Precipitations",Et=["N","N-NE","NE","E-NE","E","E-SE","SE","S-SE","S","S-SW","SW","W-SW","W","W-NW","NW","N-NW","N"],At={common:yt,temp:$t,tempHi:bt,tempLo:wt,precip:St,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:Et},xt=Object.freeze({__proto__:null,cardinalDirections:Et,common:yt,default:At,precip:St,temp:$t,tempHi:bt,tempLo:wt,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),Nt="Temperatur",Pt="Temperatur maks",Ct="Temperatur nat",Ot="Nedbør",kt=["N","N-NØ","NØ","Ø-NØ","Ø","Ø-SØ","SØ","S-SØ","S","S-SV","SV","V-SV","V","V-NV","NV","N-NV","N"],Ht={temp:Nt,tempHi:Pt,tempLo:Ct,precip:Ot,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:kt},Tt=Object.freeze({__proto__:null,cardinalDirections:kt,default:Ht,precip:Ot,temp:Nt,tempHi:Pt,tempLo:Ct,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),Dt="temperatur",Ut="Höchsttemperatur",Mt="Tiefsttemperatur",Vt="Niederschlag",Wt=["N","N-NO","NO","O-NO","O","O-SO","SO","S-SO","S","S-SW","SW","W-SW","W","W-NW","NW","N-NW","N"],Lt={temp:Dt,tempHi:Ut,tempLo:Mt,precip:Vt,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:Wt},Rt=Object.freeze({__proto__:null,cardinalDirections:Wt,default:Lt,precip:Vt,temp:Dt,tempHi:Ut,tempLo:Mt,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),zt="Temperatura",It="Temperatura máxima",jt="Temperatura mínima",Bt="Precipitations",Ft=["N","N-NE","NE","E-NE","E","E-SE","SE","S-SE","S","S-SO","SO","O-SO","O","O-NO","NO","N-NO","N"],Zt={temp:zt,tempHi:It,tempLo:jt,precip:Bt,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:Ft},Gt=Object.freeze({__proto__:null,cardinalDirections:Ft,default:Zt,precip:Bt,temp:zt,tempHi:It,tempLo:jt,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),Kt="Température",qt="Température max",Jt="Température min",Xt="Précipitations",Yt=["N","N-NE","NE","E-NE","E","E-SE","SE","S-SE","S","S-SO","SO","O-SO","O","O-NO","NO","N-NO","N"],Qt={temp:Kt,tempHi:qt,tempLo:Jt,precip:Xt,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:Yt},te=Object.freeze({__proto__:null,cardinalDirections:Yt,default:Qt,precip:Xt,temp:Kt,tempHi:qt,tempLo:Jt,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),ee="temperatuur",ie="Maximum temperatuur",se="Minimum temperatuur",ne="Neerslag",re=["N","N-NO","NO","O-NO","O","O-ZO","ZO","Z-ZO","Z","Z-ZW","ZW","W-ZW","W","W-NW","NW","N-NW","N"],oe={temp:ee,tempHi:ie,tempLo:se,precip:ne,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:re},ae=Object.freeze({__proto__:null,cardinalDirections:re,default:oe,precip:ne,temp:ee,tempHi:ie,tempLo:se,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"}),ce="Температура",le="Температура макси",he="Температура ночью",de="Осадки",pe=["С","С-СВ","СВ","В-СВ","В","В-ЮВ","ЮВ","Ю-ЮВ","Ю","Ю-ЮЗ","ЮЗ","З-ЮЗ","З","З-СЗ","СЗ","С-СЗ","С"],ue={temp:ce,tempHi:le,tempLo:he,precip:de,uPress:"гПа",uSpeed:"м/с",uPrecip:"мм",cardinalDirections:pe},ge=Object.freeze({__proto__:null,cardinalDirections:pe,default:ue,precip:de,temp:ce,tempHi:le,tempLo:he,uPrecip:"мм",uPress:"гПа",uSpeed:"м/с"}),me="Temperatur",fe="Max temperatur",_e="Min temperatur",ve="Nederbörd",ye=["N","N-NO","NO","O-NO","O","O-SO","SO","S-SO","S","S-SV","SV","V-SV","V","V-NV","NV","N-NV","N"],$e={temp:me,tempHi:fe,tempLo:_e,precip:ve,uPress:"hPa",uSpeed:"m/s",uPrecip:"mm",cardinalDirections:ye},be=Object.freeze({__proto__:null,cardinalDirections:ye,default:$e,precip:ve,temp:me,tempHi:fe,tempLo:_e,uPrecip:"mm",uPress:"hPa",uSpeed:"m/s"});!function(t){t.ENGLISH="en",t.ENGLISH_BRITISH="en_GB",t.DANISH="da",t.GERMAN="de",t.SPANISH="es",t.FRENCH="fr",t.DUTCH="nl",t.RUSSIAN="ru",t.SWEDISH="sv"}(vt||(vt={}));const we={en:xt,en_GB:xt,da:Tt,de:Rt,es:Gt,fr:te,nl:ae,ru:ge,sv:be},Se=vt.ENGLISH.valueOf();function Ee(t,e,i="",s=""){let n;try{if("test"===e.language)return"TRANSLATED";n=t.split(".").reduce(((t,e)=>t[e]),we[e.language]),n||(n=t.split(".").reduce(((t,e)=>t[e]),we[Se]))}catch(e){try{n=t.split(".").reduce(((t,e)=>t[e]),we[Se])}catch(t){n=""}}if(""!==i&&""!==s&&n){Array.isArray(i)||(i=[i]),Array.isArray(s)||(s=[s]);for(let t=0;t<i.length;t++){n=n.replace(String(i[t]),String(s[t]));const e=n.match(/\{if ([a-z]+) is ([^}]+)} ?([^{]+) ?\{else} ?([^{]+)/i);if(e&&String(i[t]).replace(/[{}']+/g,"")==e[1]){n=String(s[t])==e[2]?n.replace(e[0],e[3]):n.replace(e[0],e[4])}}}return n}const Ae=t=>t.locale||{language:t.language||vt.ENGLISH,number_format:mt.system},xe=o`
  ha-card {
    cursor: pointer;
    margin: auto;
    padding: 1.3em 1em;
...
`;var Ne;window.customCards=window.customCards||[],window.customCards.push({type:"weather-card",name:"Animated weather card",description:"Lovelace animated weather card"}),console.info("%c  WEATHER-CARD  \n%c Version: 1.8.2 ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");let Pe=Ne=class extends nt{constructor(){super(),this.isPanel=!1,this.editMode=!1,this.numberElements=0}static async getConfigElement(){return await Promise.resolve().then((function(){return ke})),document.createElement("weather-card-editor")}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={name:"",forecast_type:"daily",...t}}_needForecastSubscription(){return this._config&&this._config.entity_weather&&this._config.forecast_type&&"legacy"!==this._config.forecast_type}_unsubscribeForecastEvents(){this._subscribed&&(this._subscribed.then((t=>t())),this._subscribed=void 0)}async _subscribeForecastEvents(){var t,e,i,s;(this._unsubscribeForecastEvents(),this.isConnected&&this.hass&&this._config&&this._needForecastSubscription())&&(this._subscribed=(t=this.hass,e=this._config.entity_weather,i=this._config.forecast_type,s=t=>{this._forecastEvent=t},t.connection.subscribeMessage(s,{type:"weather/subscribe_forecast",forecast_type:i,entity_id:e})))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&this._config&&this.hass&&this._subscribeForecastEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribeForecastEvents()}shouldUpdate(t){if(!this._config)return!1;if(t.has("_config")||t.has("_forecastEvent"))return!0;if(t.has("hass"))return!0;const e=t.get("hass")||void 0;return!e||e.themes!==this.hass.themes||e.locale!==this.hass.locale||(!1===Object.keys(this._config).every((t=>null===t.match(/^entity_/)||e.states[this._config[t]]===this.hass.states[this._config[t]]))||t.has("config"))}updated(t){this.hass&&this._config&&(!t.has("_config")&&this._subscribed||this._subscribeForecastEvents())}render(){if(!this._config||!this.hass)return R;const t=this.hass.states[this._config.entity_weather];return t?W`
    ...
    `:R}_handleClick(){_t(this,"hass-more-info",{entityId:this._config.entity_weather})}renderCurrent(){this.numberElements++;const t=this.hass.states[this._config.entity_weather];return t?W`
    ...
    `:R}renderDetails(){const t=this.hass.states[this._config.entity_sun],e=this.hass.states[this._config.entity_weather];if(!e||!t)return R;const i=Ae(this.hass);let s,n;return t&&(s=new Date(t.attributes.next_rising),n=new Date(t.attributes.next_setting)),this.numberElements++,W`
      <ul class="variations ${this.numberElements>1?"spacer":""}">
        ...
        <li>
          ${Ne.getWindDir(this.hass,e.attributes.wind_bearing)}
          <ha-icon
            style="margin-left: 0;"
            .icon=${Ne.getWindDirIcon(e.attributes.wind_bearing)}
          ></ha-icon>
    ...
    `:R}_initialize(){void 0!==this.hass&&void 0!==this._config&&(this._initialized=!0)}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target;this[`_${e.configValue}`]!==e.value&&(e.configValue&&(""===e.value?delete this._config[e.configValue]:this._config={...this._config,[e.configValue]:void 0!==e.checked?e.checked:e.value}),_t(this,"config-changed",{config:this._config}))}_valueChangedNumber(t){if(!this._config||!this.hass)return;const e=t.target;this[`_${e.configValue}`]!==e.value&&(e.configValue&&(""===e.value||null===e.value?delete this._config[e.configValue]:this._config={...this._config,[e.configValue]:Number(e.value)}),_t(this,"config-changed",{config:this.sortObjectByKeys(this._config)}))}_valueChangedPicker(t){if(!this._config||!this.hass)return;const e=t.target,i=t.detail.value;this[`_${e.configValue}`]!==i&&(e.configValue&&(i?this._config={...this._config,[e.configValue]:i}:(this._config={...this._config},delete this._config[e.configValue])),_t(this,"config-changed",{config:this.sortObjectByKeys(this._config)}))}};Oe.styles=o`
    .options {
      display: grid;
    }
  ...
  `,t([pt({attribute:!1})],Oe.prototype,"hass",void 0),t([ut()],Oe.prototype,"_config",void 0),Oe=t([ht("weather-card-editor")],Oe);var ke=Object.freeze({__proto__:null,get WeatherCardEditor(){return Oe}});export{Pe as WeatherCard};
